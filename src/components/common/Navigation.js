...
const Header = () => {
  return (
    <section className='navbar' style={{ margin:'0px 20px 20px', height:'65px', width: 'calc(100% - 40px)', fontSize: '15px', fontWeight: '300', borderBottom: '1px solid grey', borderRadius: 'initial'}} >
